...
class GW_GoPricing_Shortcodes {
	...
	public function pricing_table_sc( $atts, $content = null ) {
		...
		foreach ( (array)$pricing_table['col-data'] as $col_index => $col_data ) {
			...
			$header_html = !empty( $header_data['html'] ) ? $header_data['html'] : $header_html;
			if ( !empty( $header_data['css'] ) ) $custom_inline_styles = array_merge( $custom_inline_styles, $header_data['css'] );			
			$html .= $header_html;			
			...
			foreach ( (array)$pricing_table['col-data'][$col_index]['body-row'] as $body_row_index => $body_row_data ) {
				...
				if ( !empty( $body_row_data['type'] ) ) {
					...
					if ( !empty( $body_row_inline_styles ) ) $custom_inline_styles = array_merge( $custom_inline_styles, $body_row_inline_styles );	
