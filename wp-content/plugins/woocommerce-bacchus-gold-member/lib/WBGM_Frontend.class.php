...
class WBGM_Frontend
{
	...
	public function wbgm_gold_page($form = null)
	{
        ...
        /*echo '<script>console.log(\'page gold\')</script>';
        echo '<script>console.log(' . json_encode( $this->wbgm_check_email(urlencode('pia.reppe@gmail.com'), urlencode('Pia'), urlencode('Reppe')) ) . ')</script>';
        */
