...
{
    	echo '.snp-pop-'.$ID.' .snp-newtheme6 { background: '.$POPUP_META['snp_bg_color1'].';}'."\n";
}
if (!empty($POPUP_META['snp_s1header_font']['size']))
{
	echo '.snp-pop-'.$ID.' .snp-newtheme6 {color: '.$POPUP_META['snp_s1header_font']['color'].';}';
	echo '.snp-pop-'.$ID.' .snp-newtheme6 .snp-step-1 .snp-h3 {font-size: '.$POPUP_META['snp_s1header_font']['size'].'px; color: '.$POPUP_META['snp_s1header_font']['color'].';}'."\n";
}
if (!empty($POPUP_META['snp_s1subheader_font']['size']))
{
	echo '.snp-pop-'.$ID.' .snp-newtheme6 .snp-step-1 .snp-h1{ font-size: '.$POPUP_META['snp_s1subheader_font']['size'].'px; color: '.$POPUP_META['snp_s1subheader_font']['color'].';}'."\n";
	echo '.snp-pop-'.$ID.' .snp-newtheme6 .snp-color--primary { color: '.$POPUP_META['snp_s1subheader_font']['color'].';}'."\n";
}
if (!empty($POPUP_META['snp_s2header_font']['size']))
{
	echo '.snp-pop-'.$ID.' .snp-newtheme6 {color: '.$POPUP_META['snp_s2header_font']['color'].';}';
	echo '.snp-pop-'.$ID.' .snp-newtheme6 .snp-step-2 .snp-h3 {font-size: '.$POPUP_META['snp_s2header_font']['size'].'px; color: '.$POPUP_META['snp_s2header_font']['color'].';}'."\n";
}
if (!empty($POPUP_META['snp_s1left_button_color']))
{
    	echo '.snp-pop-'.$ID.' .snp-newtheme6 .snp-step-1 .snp-btn--primary { background: '.$POPUP_META['snp_s1left_button_color'].';}'."\n";
}
if (!empty($POPUP_META['snp_s1left_button_text_color']))
{
    	echo '.snp-pop-'.$ID.' .snp-newtheme6 .snp-step-1 .snp-btn--primary { color: '.$POPUP_META['snp_s1left_button_text_color'].';}'."\n";
}
if (!empty($POPUP_META['snp_s1right_button_color']))
{
    	echo '.snp-pop-'.$ID.' .snp-newtheme6 .snp-step-1 .snp-btn--secondary { background: '.$POPUP_META['snp_s1right_button_color'].';}'."\n";
}
if (!empty($POPUP_META['snp_s1right_button_text_color']))
{
    	echo '.snp-pop-'.$ID.' .snp-newtheme6 .snp-step-1 .snp-btn--secondary { color: '.$POPUP_META['snp_s1right_button_text_color'].';}'."\n";
}
if (!empty($POPUP_META['snp_submit_button_color']))
{
    	echo '.snp-pop-'.$ID.' .snp-newtheme6 .snp-step-2 .snp-btn--primary { background: '.$POPUP_META['snp_submit_button_color'].';}'."\n";
}
if (!empty($POPUP_META['snp_submit_button_text_color']))
{
    	echo '.snp-pop-'.$ID.' .snp-newtheme6 .snp-step-2 .snp-btn--primary { color: '.$POPUP_META['snp_submit_button_text_color'].';}'."\n";
}
if (!empty($POPUP_META['snp_s3button_color']))
{
    	echo '.snp-pop-'.$ID.' .snp-newtheme6 .snp-step-3 .snp-btn--secondary { background: '.$POPUP_META['snp_s3button_color'].';}'."\n";
}
if (!empty($POPUP_META['snp_s3button_text_color']))
{
    	echo '.snp-pop-'.$ID.' .snp-newtheme6 .snp-step-3 .snp-btn--secondary { color: '.$POPUP_META['snp_s3button_text_color'].';}'."\n";
}
if (!empty($POPUP_META['snp_s3header_font']['size']))
{
	echo '.snp-pop-'.$ID.' .snp-newtheme6 .snp-step-3 .snp-h2 {font-size: '.$POPUP_META['snp_s3header_font']['size'].'px; color: '.$POPUP_META['snp_s3header_font']['color'].';}'."\n";
}
if (!empty($POPUP_META['snp_s3subheader_font']['size']))
{
	echo '.snp-pop-'.$ID.' .snp-newtheme6 .snp-step-3 .snp-h1 { font-size: '.$POPUP_META['snp_s3subheader_font']['size'].'px; color: '.$POPUP_META['snp_s3subheader_font']['color'].';}'."\n";
}
echo '</style>';
