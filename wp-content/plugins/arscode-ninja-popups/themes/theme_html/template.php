...
if ($POPUP_META['snp_bg_gradient'])
{
	...
	?>
		...
		.snp-pop-<?php echo $ID; ?> .snp-theme-html .snp-powered {
		  ...
		  <?php if (!empty($POPUP_META['snp_closetext_color'])) {echo 'color: '.$POPUP_META['snp_closetext_color'].';';}?>
		}
	<?php
	}
}
...
{
	echo '.snp-pop-'.$ID.' .snp-theme-html .snp-no-thx, .snp-pop-'.$ID.' .snp-theme-html .snp-powered , .snp-pop-'.$ID.' .snp-theme-html .snp-privacy { color: '.$POPUP_META['snp_closetext_color'].';}';
}
echo '</style>';
?>