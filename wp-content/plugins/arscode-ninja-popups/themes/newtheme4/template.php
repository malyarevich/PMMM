...
{
	echo '.snp-pop-'.$ID.' .snp-newtheme4 h2 {font-size: '.$POPUP_META['snp_header_font']['size'].'px; color: '.$POPUP_META['snp_header_font']['color'].';}'."\n";
}
if (!empty($POPUP_META['snp_subheader_font']['size']))
{
	...
	echo '.snp-pop-'.$ID.' .snp-newtheme4 h3 {color: '.$POPUP_META['snp_subheader_font']['color'].';}'."\n";
}
if (!empty($POPUP_META['snp_maintext_font']['size']))
{
	echo '.snp-pop-'.$ID.' .snp-newtheme4 p {font-size: '.$POPUP_META['snp_maintext_font']['size'].'px;}'."\n";
	echo '.snp-pop-'.$ID.' .snp-newtheme4 p {color: '.$POPUP_META['snp_maintext_font']['color'].';}'."\n";
}
if (!empty($POPUP_META['snp_submit_button_text_color']))
{
    	echo '.snp-pop-'.$ID.' .snp-newtheme4 .snp-submit { color: '.$POPUP_META['snp_submit_button_text_color'].';}'."\n";
}
if (!empty($POPUP_META['snp_submit_button_color']))
{
    	echo '.snp-pop-'.$ID.' .snp-newtheme4 .snp-submit { background-color: '.$POPUP_META['snp_submit_button_color'].';}'."\n";
}
if (!empty($POPUP_META['snp_submit_button_shadow_color']))
{
    	echo '.snp-pop-'.$ID.' .snp-newtheme4 form input[type="submit"] { -webkit-box-shadow: 4px 4px 0 '.$POPUP_META['snp_submit_button_shadow_color'].'; -moz-box-shadow: 4px 4px 0 '.$POPUP_META['snp_submit_button_shadow_color'].'; box-shadow: 4px 4px 0 '.$POPUP_META['snp_submit_button_shadow_color'].';}'."\n";
	echo '.snp-pop-'.$ID.' .snp-newtheme4 form input[type="submit"]:hover { -webkit-box-shadow: 0 0 0 '.$POPUP_META['snp_submit_button_shadow_color'].'; -moz-box-shadow: 0 0 0 '.$POPUP_META['snp_submit_button_shadow_color'].'; box-shadow: 0 0 0 '.$POPUP_META['snp_submit_button_shadow_color'].';}'."\n";
}

if (!empty($POPUP_META['snp_bg_color1']))
{
    	echo '.snp-pop-'.$ID.' .snp-newtheme4 .snp-newsletter-content { background: '.$POPUP_META['snp_bg_color1'].';}'."\n";
}
if (!empty($POPUP_META['snp_fields_labels_color']))
{
    	echo '.snp-pop-'.$ID.' .snp-newtheme4 .snp-newsletter-content { color: '.$POPUP_META['snp_fields_labels_color'].';}'."\n";
	echo '.snp-pop-'.$ID.' .snp-newtheme4 .snp-newsletter-content p { color: '.$POPUP_META['snp_fields_labels_color'].';}'."\n";
}
