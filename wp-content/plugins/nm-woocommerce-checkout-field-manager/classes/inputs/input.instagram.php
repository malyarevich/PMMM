...
class NM_Instagram_cofm extends NM_Inputs_cofm{
	...
	*/
	...
	function __construct(){
		...
		$this -> title 		= __ ( 'Instagram import', 'nm-cofm' );
		$this -> desc		= __ ( 'Import photo from Instagram', 'nm-cofm' );
	...
	private function get_settings(){
		...
		return array (
				...
				'button_label_import' => array (
						'type' => 'text',
						'title' => __ ( 'Button label', 'nm-cofm' ),
						'desc' => __ ( 'Type button label e.g: Import Photos', 'nm-cofm' ) 
				),
				'button_class' => array (
						'type' => 'text',
						'title' => __ ( 'Button class', 'nm-cofm' ),
						'desc' => __ ( 'Type class for import button', 'nm-cofm' )
				),
	
				'client_id' => array (
						'type' => 'text',
						'title' => __ ( 'Client ID', 'nm-cofm' ),
						'desc' => __ ( 'Get client id from your Instagram app.', 'nm-cofm' )
				),
				'client_secret' => array (
						'type' => 'text',
						'title' => __ ( 'Client secret', 'nm-cofm' ),
						'desc' => __ ( 'Get client secret from your Instagram app.', 'nm-cofm' )
				),
				'redirect_uri' => array (
						'type' => 'text',
						'title' => __ ( 'Redirect URI', 'nm-cofm' ),
						'desc' => __ ( 'Paste redirect uri you used in Instagram app page, it MUST be matched.', 'nm-cofm' )
				),
	...
	*/
	...
	function build_import_link($control_id = 'instaupload'){
		...
		$html 	= '<div class="btn_center">';
			...
			$html	.= __('Import photos from Instagram', 'nm-cofm');
			$html 	.= '</a>';
		$html 	.= '</div>';			
	}
