	...
	*/
    ...
    if ( ! function_exists( 'sf_custom_styles' ) ) {
        function sf_custom_styles() {
            ...
            echo 'span.highlighted, span.dropcap4, .loved-item:hover .loved-count, .flickr-widget li, .portfolio-grid li, figcaption .product-added, .woocommerce .widget_layered_nav ul li.chosen small.count, .widget_layered_nav ul > li, .woocommerce .widget_layered_nav_filters ul li a, .sticky-post-icon, .fw-video-close:hover {background-color: ' . $accent_color . '!important; color: ' . $accent_alt_color . '!important;}';
...
//            echo '.woocommerce input.button:hover, .woocommerce a.button:hover {background-color:'.$secondary_accent_color.';color:'.$accent_alt_color.';}';			
            ...
            if ( $disable_mobile_animations ) {
                ...
                echo 'html.no-js .sf-animation.image-banner-content, .mobile-browser .sf-animation.image-banner-content, .apple-mobile-browser .sf-animation.image-banner-content {
				bottom: 50%!important;}';
