...
if ( ! function_exists( 'vendidero_helper_activated' ) ) {
	...
	function vendidero_helper_activated() {
		...
		if ( is_multisite() && ! ( is_plugin_active_for_network( 'vendidero-helper/vendidero-helper.php' ) || in_array( 'vendidero-helper/vendidero-helper.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) )
			return false;
