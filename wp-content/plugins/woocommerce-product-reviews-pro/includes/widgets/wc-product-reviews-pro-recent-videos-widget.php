 ...
 * @since 1.5.0
 */
class WC_Product_Reviews_Pro_Recent_Videos_Widget extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_cssclass    = 'woocommerce widget_recent_videos widget_product_reviews_pro';
		$this->widget_description = __( 'Display a list of most recent video contributions from Product Reviews Pro on your site.', 'woocommerce-product-reviews-pro' );
		$this->widget_id          = 'wc_product_reviews_pro_recent_videos';
		$this->widget_name        = __( 'WooCommerce Product Reviews Pro: Videos', 'woocommerce-product-reviews-pro' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => __( 'Recent Videos', 'woocommerce-product-reviews-pro' ),
			...
			'number' => array(
				...
				'max'   => '',
				'std'   => 10,
				'label' => __( 'Number of video contributions to show', 'woocommerce-product-reviews-pro' )
			)
		);
	...
	/**
	 * Render the Product Reviews Pro Recent Videos widget
	 *
	 * @since 1.5.0
...
} // end \WC_Product_Reviews_Pro_Recent_Videos_Widget class
