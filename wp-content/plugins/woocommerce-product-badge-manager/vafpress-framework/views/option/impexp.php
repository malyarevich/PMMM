<div class="vp-field vp-textarea" data-vp-type="vp-textarea">
	<div class="label">
		<label>
			<?php _e('Import', 'woo_product_badge_manager_txtd') ?>
		</label>
		<div class="description">
			<p><?php _e('Import Options', 'woo_product_badge_manager_txtd') ?></p>
		</div>
	</div>
	<div class="field">
		<div class="input">
			...
			<div class="buttons">
				<input id="vp-js-import" class="vp-button button" type="button" value="<?php _e('Import', 'woo_product_badge_manager_txtd') ?>" />
...
<div class="vp-field vp-textarea" data-vp-type="vp-textarea">
	<div class="label">
		<label>
			<?php _e('Export', 'woo_product_badge_manager_txtd') ?>
		</label>
		<div class="description">
			<p><?php _e('Export Options', 'woo_product_badge_manager_txtd') ?></p>
		</div>
	</div>
	<div class="field">
		<div class="input">
			...
			<div class="buttons">
				<input id="vp-js-export" class="vp-button button" type="button" value="<?php _e('Export', 'woo_product_badge_manager_txtd') ?>" />
				<span style="margin-left: 10px;">
