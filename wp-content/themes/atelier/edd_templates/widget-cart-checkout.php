...
<div class="bag-total cart_item edd-cart-meta edd_total">
	<p class="total-title"><?php _e( 'Total:', 'swiftframework' ); ?></p>
...
<div class="bag-buttons edd_checkout">
	<a class="sf-button standard sf-icon-reveal checkout-button" href="<?php echo esc_url( edd_get_checkout_uri() ); ?>"><?php echo $checkout_icon; ?><span class="text"><?php _e( 'Checkout', 'swiftframework' ); ?></span></a>
</div>