...
class VP_ShortcodeGenerator
{
	...
	function print_form($attributes)
	{
		...
		<div class="vp-sc-action">
			<button class="vp-sc-insert button"><?php _e('Insert', 'woo_product_badge_manager_txtd'); ?></button>
			<button class="vp-sc-cancel button"><?php _e('Cancel', 'woo_product_badge_manager_txtd') ?></button>
		</div>
		<?php
	}
