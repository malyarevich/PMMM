...
<p>
	...
	printf(
		__( 'Hello %1$s, a new comment has been posted to a %2$s %3$s you are watching on %4$s.', 'woocommerce-product-reviews-pro' ),
		$user->display_name,
		$product->get_title(),
...
<p>
	<?php
	printf(
		'<strong><a href="%s" target="_blank">' .
		esc_html__( 'View new comment.', 'woocommerce-product-reviews-pro' ) .
...
<p>
	<?php
	/* translators: Placeholders: %1$s contribution type - %2$s <a> html opening tag - %3$s </a> html closing tag */
	printf(
		__( 'If you no longer wish to receive notifications for new replies to this %1$s, please %2$sfollow this link%3$s.', 'woocommerce-product-reviews-pro' ),
		strtolower( $contribution_type->get_title() ),
