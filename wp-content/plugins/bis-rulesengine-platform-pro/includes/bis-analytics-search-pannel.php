            <div class="col-md-3">
                ...
                <select name="bis_report_type" size="2" id="bis_report_type">
                    <option value="donut" selected="selected"> <?php _e("Donut Chart", BIS_RULES_ENGINE_TEXT_DOMAIN); ?></option>
                    <option value="pie" ><?php _e("Pie Chart", BIS_RULES_ENGINE_TEXT_DOMAIN); ?></option>
                </select>
            </div>
            <div class="col-md-3">
 ...
 <script>
    jQuery(document).ready(function () {
        ...
        jQuery('#bis_report_type').multiselect('select', 'donut');       
        jQuery('#bis_report_type').multiselect('deselect', 'pie');       
