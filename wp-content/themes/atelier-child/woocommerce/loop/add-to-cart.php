...
<?php else : ?>
	...
	//
	$minimum_allowed_quantity_loop = '';
	if ( class_exists( 'Incremental_Product_Quantities' ) ) {
		$min_value = apply_filters( 'woocommerce_quantity_input_min', '', $product );
		if ( 1 < $min_value ) {
			$minimum_allowed_quantity_loop = ' data-quantity="' . $min_value . '"';
		}
	}
		// Add to Cart
