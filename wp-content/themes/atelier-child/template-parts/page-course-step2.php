...
switch ((int)$_SESSION['course_step']) {
    case 2: {
        ...
        echo '<button data-step="1" class="back-quiz-step back-quiz-step-custom quiz-step">< zurück </button>';
        break;
    }
    case 5: {
        ...
        echo '<button data-step="4" class="back-quiz-step back-quiz-step-custom quiz-step">< zurück </button>';
        break;
    }
    case 8: {
        ...
        echo '<button data-step="7" class="back-quiz-step back-quiz-step-custom quiz-step">< zurück </button>';
        break;
    }
    case 11: {
        ...
        echo '<button data-step="10" class="back-quiz-step back-quiz-step-custom quiz-step">< zurück </button>';
        break;
    }
    case 14: {
        ...
        echo '<button data-step="13" class="back-quiz-step back-quiz-step-custom quiz-step">< zurück </button>';
        break;
    }
    case 17: {
        ...
        echo '<button data-step="16" class="back-quiz-step back-quiz-step-custom quiz-step">< zurück </button>';
        break;
    }
}
?>