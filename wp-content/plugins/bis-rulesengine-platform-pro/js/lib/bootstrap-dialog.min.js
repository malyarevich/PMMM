(function (a, b) {
    ...
    c.prototype = {
        constructor: c, getGlobalOpenedDialogs: function () {
            var e = [];
    ...
    a.prototype = {
        constructor: a, initOptions: function (e) {
            ...
            this.getModal().on("show.bs.modal", {dialog: this}, function (f) {
                var e = f.data.dialog;
                if (e.isModalEvent(f) && typeof e.options.onshow === "function") {
    ...
    a.confirm = function (e, f) {
        return new a({
            ...
            data: {callback: f},
            buttons: [{
                label: a.DEFAULT_TEXTS.CANCEL, action: function (g) {
                    typeof g.getData("callback") === "function" && g.getData("callback")(false);
                    g.close()
                }
            }, {
                label: a.DEFAULT_TEXTS.OK, cssClass: "btn-primary", action: function (g) {
                    typeof g.getData("callback") === "function" && g.getData("callback")(true);
                    g.close()
                }
            }]
