				...
				$this->sections[] = array(
					...
					'fields' => array(
						...
						array(
							'id' => 'lightbox_enabled',
							'type' => 'button_set',
							'title' => __('Lightbox Enabled', 'swiftframework'),
							'subtitle' => __('Select if you would like to enable or disable the built-in lightbox.', 'swiftframework'),
							'desc' => '',
							'options' => array('1' => 'Enabled','0' => 'Disabled'),
							'default' => '1'
							),
...
//							),
						...
						array(
							...
							'subtitle' => __('Set whether you would like the site search limited to a specific post type, or all content. Leave blank for all.', 'swiftframework'),
							'desc' => '',
							'default' => 'any'
							),
						array(
