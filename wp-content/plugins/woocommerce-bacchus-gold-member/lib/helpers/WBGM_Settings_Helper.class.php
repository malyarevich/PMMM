...
class WBGM_Settings_Helper
{
	...
	protected static function __init()
	{
        ...
        $settings['global_options'][ self::PREFIX . 'btn_adding_to_cart_text' ] = get_option( self::PREFIX . 'btn_adding_to_cart_text' );
     ...
     * @param boolean $bool key of variable
     * @param string $type type
     * @param boolean $prefix adds prefix to key or not
     *
