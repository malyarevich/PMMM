...
<form method="POST" action="" id="log_form">
    <table class="wp-list-table widefat fixed striped posts" >
        <thead><tr><th class="manage-column column-snp_theme">Action</th><th class="manage-column column-snp_theme">Date</th><th class="manage-column column-snp_theme">Email</th><th class="manage-column column-snp_theme">Popup</th><th class="manage-column column-snp_theme">List</th><th class="manage-column column-snp_theme">Browser</th><th class="manage-column column-snp_theme">IP</th><th class="manage-column column-snp_theme">Custom Fields</th><th class="manage-column column-snp_theme">Referer</th><th class="manage-column column-snp_theme">Errors</th><th class="manage-column column-cb check-column"><input type="checkbox" class="log-checkbox" id="log_checkbox" ></th></tr></thead>
        <tbody>
                <?php
    ...
    <?php           //      pagination
      //  $count_pages = $wpdb->get_row('SELECT COUNT(id) AS number FROM '. $wpdb->prefix .'snp_log'  );
        $paginate_args = array(
            'base'               => '%_%',
            'format'             => '?pages=%#%',
...
<script type="text/javascript"> jQuery(document).ready(function(){ jQuery(".snp-datepicker").datepicker({dateFormat: "yy-mm-dd"});  }); </script>
<?php
