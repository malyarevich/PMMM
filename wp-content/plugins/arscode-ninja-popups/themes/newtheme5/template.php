...
{
	echo '.snp-pop-'.$ID.' .snp-newtheme5 h2 {font-size: '.$POPUP_META['snp_header_font']['size'].'px; color: '.$POPUP_META['snp_header_font']['color'].';}'."\n";
}
if (!empty($POPUP_META['snp_maintext_font']['size']))
{
	echo '.snp-pop-'.$ID.' .snp-newtheme5 p {font-size: '.$POPUP_META['snp_maintext_font']['size'].'px;}'."\n";
	echo '.snp-pop-'.$ID.' .snp-newtheme5 p {color: '.$POPUP_META['snp_maintext_font']['color'].';}'."\n";
}
if (!empty($POPUP_META['snp_submit_button_text_color']))
{
    	echo '.snp-pop-'.$ID.' .snp-newtheme5 .snp-submit { color: '.$POPUP_META['snp_submit_button_text_color'].';}'."\n";
}
if (!empty($POPUP_META['snp_submit_button_color']))
{
    	echo '.snp-pop-'.$ID.' .snp-newtheme5 .snp-submit { background-color: '.$POPUP_META['snp_submit_button_color'].';}'."\n";
}
if (!empty($POPUP_META['snp_submit_button_hover_color']))
{
    	echo '.snp-pop-'.$ID.' .snp-newtheme5 form input[type="submit"]:hover { background-color: '.$POPUP_META['snp_submit_button_hover_color'].';}'."\n";
}

if (!empty($POPUP_META['snp_bg_color']))
{
    	echo '.snp-pop-'.$ID.' .snp-newtheme5 { background: '.$POPUP_META['snp_bg_color'].';}'."\n";
}
if (!empty($POPUP_META['snp_bottom_border']))
{
    	echo '.snp-pop-'.$ID.' .snp-newtheme5 {border-bottom: 10px solid '.$POPUP_META['snp_bottom_border'].';}'."\n";
}
echo '</style>';
