 ...
 * @since 1.5.0
 */
class WC_Product_Reviews_Pro_Recent_Reviews_Widget extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_cssclass    = 'woocommerce widget_recent_reviews widget_product_reviews_pro';
		$this->widget_description = __( 'Display a list of most recent reviews from Product Reviews Pro on your site.', 'woocommerce-product-reviews-pro' );
		$this->widget_id          = 'wc_product_reviews_pro_recent_reviews';
		$this->widget_name        = __( 'WooCommerce Product Reviews Pro: Reviews', 'woocommerce-product-reviews-pro' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => __( 'Recent Reviews', 'woocommerce-product-reviews-pro' ),
			...
			'number' => array(
				...
				'max'   => '',
				'std'   => 10,
				'label' => __( 'Number of reviews to show', 'woocommerce-product-reviews-pro' )
			)
		);
	...
	/**
	 * Render the Product Reviews Pro Recent Reviews widget
	 *
	 * @since 1.5.0
...
} // end \WC_Product_Reviews_Pro_Recent_Reviews_Widget class
