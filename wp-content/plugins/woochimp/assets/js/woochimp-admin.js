...
jQuery(document).ready(function() {
            ...
            function(response) {
                ...
                if (result && typeof result['message'] === 'object') {
                    ...
                    if (typeof result['message']['lists'] === 'object') {
                        ...
                        // Make it select2!
                        jQuery('#woochimp_list_'+object_type).select2({
                    ...
                    if (typeof result['message']['groups'] === 'object') {
                        ...
                        // Make it select2!
                        jQuery('#woochimp_groups_'+object_type).select2({
            ...
            function(response) {
                ...
                if (result && typeof result['message'] === 'object') {
                    ...
                    if (typeof result['message']['groups'] === 'object') {
                        ...
                        // Make it select2!
                        jQuery('#woochimp_groups_'+page).select2({
                            placeholder: woochimp_label_select_some_groups,
                            width: '400px',
                        });
                    }
    ...
    function render_merge_fields_table(available_fields, selected_fields, page, list_id, checkout_properties) {
        ...
        jQuery('#woochimp_add_field').click( function() {
            ...
            jQuery('#woochimp_field_tag_'+current_id).select2('destroy');
            ...
            jQuery('#woochimp_fields_table tbody>tr:last').each( function() {
                ...
                jQuery('#woochimp_field_tag_'+current_id).select2({
                    placeholder: woochimp_label_select_tag,
                    width: '300px'
                });
                jQuery('#woochimp_field_tag_'+next_id).select2({
                    placeholder: woochimp_label_select_tag,
                    width: '300px'
                });
            });
    ...
    if (jQuery('.woochimp_list_checkout').length) {
                ...
                if (result && typeof result['message'] === 'object') {
                    ...
                    jQuery('.woochimp_list_checkout').each(function () {
                        ...
                        if (typeof result['message']['lists'] === 'object') {
                            ...
                            // Make it select2!
                            jQuery('#woochimp_list_checkout_'+ current_field_id).select2({
                                placeholder: woochimp_label_select_mailing_list,
                                width: '400px'
                            }).change(function(e) {
                            ...
                            if (typeof result['message']['groups'] === 'object') {
                                ...
                                // Make it select2!
                                jQuery('#woochimp_groups_checkout_'+ current_field_id).select2({
                                    placeholder: woochimp_label_select_some_groups,
                                    width: '400px'
                                });
        ...
        function render_checkout_merge_fields_table(current_field_id, current_selected_list, current_selected_merge, merge_fields, checkout_properties) {
            ...
            var fields_to_start_optgroup = ['order_billing_first_name', 'order_shipping_first_name', 'order_shipping_method_title', 'order_user_id', 'custom_order_field'];
            ...
            jQuery('#woochimp_fields_table_'+current_field_id).find('#woochimp_add_field').each(function() {
                jQuery(this).click( function() {
                    ...
                    // Remove select2 from last element
                    jQuery($table).find('#woochimp_field_tag_'+current_field_id+'_'+current_id).select2('destroy');
                    ...
                    jQuery($table).find('tbody>tr:last').each( function() {
                        ...
                        // Make both tag fields select2
                        jQuery('#woochimp_field_tag_'+current_field_id+'_'+current_id).select2({
                            placeholder: woochimp_label_select_tag,
                            width: '300px'
                        });
                        jQuery('#woochimp_field_tag_'+current_field_id+'_'+next_id).select2({
                            placeholder: woochimp_label_select_tag,
                            width: '300px'
                        });
                    });
    ...
    function is_custom_checkout_field(field_name) {
        ...
        if (['custom_order_field', 'static_value'].indexOf(field_name) !== -1) {
            return true;
        }
    ...
    function create_custom_value_field(select_name_field, field_name) {
        ...
        var custom_field_label_index = ['custom_order_field', 'static_value'].indexOf(field_name);
    ...
    jQuery('#woochimp_add_set').click(function() {
        ...
        for (var i=0, len=select2_removed_from.length; i<len; i++) {
            if (select2_removed_from[i].search('woochimp_list_checkout_') !== -1) {
                jQuery('#'+select2_removed_from[i]).select2({
                    placeholder: woochimp_label_select_mailing_list,
                    width: '400px'
                });
            }
        ...
        jQuery('#woochimp_list_groups_list>div:last-child').find('select').each(function() {
            ...
            if (current_select_id.search('woochimp_list_checkout_') !== -1) {
                jQuery('#'+current_select_id).select2({
                    placeholder: woochimp_label_select_mailing_list,
                    width: '400px'
                });
            }
     ...
     * Woochimp Log
     */
    var log_box_link = '<a href="#" id="woochimp_log_link">' + woochimp_log_link + '</a>';
    var log_box = '<textarea class="code" readonly="readonly" id="woochimp_log">' + woochimp_log + '</textarea>';

    jQuery('#woochimp_enable_log').each(function(){

        jQuery(this).parent().append(log_box_link).append(log_box);
        jQuery('#woochimp_log_link').hide();
        jQuery('#woochimp_log').hide();
    ...
    jQuery('#woochimp_log_link').click(function(e){
        e.preventDefault();
        jQuery('#woochimp_log').show();
    });
