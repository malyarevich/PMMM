...
<div class="woocommerce-gzpd-checkout-verify-data">
	...
	<div class="row addresses">
		...
		<div class="columns large-3">
			...
			<header class="title">
					<h4><?php _e( 'Billing Details', 'woocommerce-germanized-pro' ); ?> <a href="#step-address" class="edit step-trigger" data-href="address"><?php echo _x( 'edit', 'multistep', 'woocommerce-germanized-pro' ); ?></a></h4>
			</header>
		...
		<div class="columns large-3">
			...
			<header class="title">
				<h4><?php _e( 'Shipping Address', 'woocommerce-germanized-pro' ); ?> <a href="#step-address" class="edit step-trigger" data-href="address"><?php echo _x( 'edit', 'multistep', 'woocommerce-germanized-pro' ); ?></a></h4>
			</header>
			<address>
				<?php
