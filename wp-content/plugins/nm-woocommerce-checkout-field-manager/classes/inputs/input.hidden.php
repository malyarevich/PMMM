...
class NM_Hidden_cofm extends NM_Inputs_cofm{
	...
	*/
	...
	function __construct(){
		...
		$this -> title 		= __ ( 'Hidden Input', 'nm-cofm' );
		$this -> desc		= __ ( 'regular hidden input', 'nm-cofm' );
	...
	private function get_settings(){
		...
		return array (
					...
					'field_value' => array (
							'type' => 'text',
							'title' => __ ( 'Field value', 'nm-cofm' ),
							'desc' => __ ( 'you can pre-set the value of this hidden input.', 'nm-cofm' )
					),
				);
	}
